...
Немного деталей:
1. Вполне достаточно будет сделать поддержку только Map<String, Integer>. Не надо универсального решения для любых типов данных. Для List, Set и прочего вполне достаточно сделать List<Integer> или List<String>
2. Можно использовать любые redis-решения: голую редиску, sentinel или redis-cluster. 
3. Ну и вообще - делайте что хотите, лишь бы работало.
4. По всем вопросам смело писать на vgv@ecwid.com