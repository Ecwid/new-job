...
Выполнять работу необходимо на Kotlin или Java (версия 11 или выше). По всем вопросам смело писать на join@ecwid.com, сделанное задание отправлять туда же.
